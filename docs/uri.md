...
```
ltz:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu
ltz:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2
ltz:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2&message=Payment&label=Satoshi&extra=other-param
```
...
```javascript
var uriString = 'ltz:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2';
